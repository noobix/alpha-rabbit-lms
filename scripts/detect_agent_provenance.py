...
AGENT_PATTERNS = [
    ...
    (re.compile(r"\b(?:(?:generated|authored|created|written|produced|assisted)\s+by\s+(?:github\s+)?copilot|(?:github\s+)?copilot[- ](?:generated|authored|assisted))\b", re.I), "github-copilot"),
