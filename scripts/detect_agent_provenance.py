...
_COPILOT_PATTERN = (
    r"\b(?:(?:generated|authored|created|written|produced|assisted)"
    r"\s+by\s+(?:github\s+)?copilot"
    r"|(?:github\s+)?copilot[- ](?:generated|authored|assisted))\b"
)

AGENT_PATTERNS = [
    (re.compile(r"Generated by GitHub Copilot", re.I), "github-copilot"),
    (re.compile(_COPILOT_PATTERN, re.I), "github-copilot"),
